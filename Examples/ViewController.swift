...
extension ViewController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        _ = activityIndicator.transitionSavedState(mapStateForIdx(row), animated: true)
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        _ = activityIndicator.transitionSavedState(Names.Inactive, animated: false)
        updateForPickerActivityState()
    }
    ...
    func nextState() {
        ...
        case Names.Inactive:
            _ = activityIndicator.transitionSavedState(Names.Spinning)
            
        case Names.Spinning:
            _ = activityIndicator.transitionSavedState(Names.ProgressBar)
            
        case Names.ProgressBar:
            _ = activityIndicator.transitionSavedState(Names.Paused)
            
        case Names.Paused:
            _ = activityIndicator.transitionSavedState(Names.ProgressBar)
            
        default:
            _ = activityIndicator.transitionSavedState(Names.Inactive)
        }
        updateForPickerActivityState()
    }
